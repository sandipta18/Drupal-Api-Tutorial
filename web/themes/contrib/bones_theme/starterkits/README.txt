...
You might want to rename the subtheme to something else, such as the name of the particular website you're building. To do this, find & replace all instances of 'bones_subtheme' with your new name, as well as edit the info.yml details.
